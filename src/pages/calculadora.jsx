    ...
    return (
        <div className="calculadora">
            ...
            <div className="teclado">
                <button className="limpiar" onClick={() => manejarClicBoton('C')}>AC</button>
                <button className="limpiar" ></button>
                <button className="limpiar" ></button>
                ...
                <button className="operador" onClick={() => manejarClicBoton('*')}>x</button>
